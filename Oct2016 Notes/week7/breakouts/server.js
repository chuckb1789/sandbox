...
app.post('/saveSettings', (req, res)=>{
    ...
    // tell the browser to set a cookie for each setting that was passed up
    for(var setting in req.body){
        res.cookie(setting, req.body[setting]);
    }

    // could optionally store the settings in the database if we wanted them to be truly persistent (still be stored even if the user clears their cookies)
